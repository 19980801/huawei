        ...
        <div class="row pr-3">
          <div id="preview" class="col pr-0">
            <div class="card bg-transparent mr-5 position-absolute">
              ...
              <!--vue中专门控制显示隐藏的属性v-show -->
              <div id="mask" class="position-absolute" v-show="show" :style="maskStyle"></div>
              <!-- 凡是以$开头的都是vue内置的对象；$event是vue封装的DOM中的事件对象；旧版vue框架$(event)必须要写 -->
              <!-- vue中获得事件的办法e -->
              <div id="super-mask" class="position-absolute" @mouseover="display" @mouseout="hide" @mousemove="move($event)"></div>
              <div id="div-lg" class="position-absolute" :style="lgDivStyle" v-show="show"></div>
              <div class="card-body p-0 text-center">
                <img src="http://127.0.0.1:3000/img/product_detail/hover-prev.png" class="btn float-left btn-light border-0 p-1 pt-4 pb-4 disabled" :class="btnLeftDisabled==true?'disabled':''" @click="moveRight">
                <div class="d-inline-block pt-2 mx-0 m-auto">
                  <!-- <ul class="list-unstyled mb-0"> -->
                  <ul class="list-unstyled mb-0" :style="ulImgsStyle">
                ...
                <img src="http://127.0.0.1:3000/img/product_detail/hover-next.png" class="btn float-right btn-light border-0 p-1 pt-4 pb-4" :class="btnRightDisabled==true?'disabled':''" @click="moveLeft">
              </div>
            </div>
          </div>
          <div id="details" class="col pl-0">
            ...
            <p class="mb-1">
              ...
              <img class="mb-3" src="http://127.0.0.1:3000/img/product_detail/kefuf.gif">
            </p>
            <!-- 规格 -->
            <div>
              <div class="float-left small">规格：</div>
              <div class="float-left w-75">
                <router-link class="btn btn-sm btn-outline-secondary" v-for="(sp,i) of specs" :key="i" :to="`/details/${sp.lid}`" v-text="sp.spec" :class="lid==sp.lid?'active':''">双核i5/8GB内存/128GB闪存</router-link>
            ...
            <div>
              ...
              <a class="btn btn-primary pt-3" href="javascript:;">
                <h5><img src="http://127.0.0.1:3000/img/product_detail/product_detail_img7.png" alt=""> 加入购物车</h5>
              </a>
              <a class="btn btn-primary pt-1 pb-1 collection" href="javascript:;">
                <img src="http://127.0.0.1:3000/img/product_detail/product_detail_img6.png">
                <br>
                收藏
              </a>
            </div>
          ...
          <ul class="list-unstyled" style="width: 1100px; margin-left:-220px;">
            <li class="float-left">
              <div class="card mb-1 p-4 border-0 bg-transparent box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="http://127.0.0.1:3000/img/product_detail/product_detail_1.png" data-holder-rendered="true">
            ...
            <li class="float-left">
              <div class="card mb-1 p-4 border-0 bg-transparent box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="http://127.0.0.1:3000/img/product_detail/product_detail_2.png" data-holder-rendered="true" >
                <div class="card-body p-0">
            ...
            <li class="float-left">
              <div class="card mb-1 p-4 border-0 bg-transparent box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="http://127.0.0.1:3000/img/product_detail/product_detail_3.png" data-holder-rendered="true" >
                <div class="card-body p-0">
            ...
            <li class="float-left">
              <div class="card mb-1 p-4 border-0 bg-transparent box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="http://127.0.0.1:3000/img/product_detail/product_detail_4.png" data-holder-rendered="true" >
                <div class="card-body p-0">
      ...
      <div id="params" class="container">
        <div class="row mr-1">
          <div class="col-md-10 pt-5">
            <a name="规格参数"></a>
            <h6 class="d-inline-block ml-3">规格参数 <img src="http://127.0.0.1:3000/img/product_detail/product_detail_icon_1.png" alt=""></h6>
            <div class="pl-3">
            ...
            <a name="商品介绍"></a>
            <h6 class="d-inline-block mt-4 mb-3 ml-3">商品介绍 <img src="http://127.0.0.1:3000/img/product_detail/product_detail_icon_4.png" alt=""></h6>
            <div> 
              <div>   
                <div>
                  <img alt="" class="" src="http://127.0.0.1:3000/img/product/detail/57b15612N81dc489d.jpg">   
                </div>  
              </div>
              <div>   
                <div>    
                  <img alt="" class="" src="http://127.0.0.1:3000/img/product/detail/57b15616N1e285f09.jpg">   
                </div>  
              </div>
              <div>   
            ...
            <a name="售后保障"></a>
            <h6 class="d-inline-block mt-4 mb-3 ml-3">售后保障 <img src="http://127.0.0.1:3000/img/product_detail/product_detail_icon_3.png" alt=""></h6>
            <div class="pl-3"> 
              <div>
                <p class="text-primary font-weight-bold">
                  <img src="http://127.0.0.1:3000/img/product_detail/product_detail_img16.png" alt="">
                  正品保障
                </p>
                <p class="small">
            ...
            <a name="包装清单"></a>
            <h6 class="d-inline-block mt-4 mb-3 ml-3">包装清单 <img src="http://127.0.0.1:3000/img/product_detail/product_detail_icon_2.png" alt=""></h6>
            <div class="pl-3">
          ...
          <div class="col-md-2 mb-4 pt-5 pl-2">
            <a class="btn p-3 pl-4 pr-4 mb-2" href="#规格参数">
              <h5 class="text-dark mb-0"><img src="http://127.0.0.1:3000/img/product_detail/product_detail_icon_g_1.png" alt=""> 规格参数</h5>
            </a>
            <a class="btn p-3 pl-4 pr-4 mb-2" href="#商品介绍">
              <h5 class="text-dark mb-0k"><img src="http://127.0.0.1:3000/img/product_detail/product_detail_icon_t_1.png" alt=""> 商品介绍</h5>
            </a>
            <a class="btn p-3 pl-4 pr-4 mb-2" href="#售后保障">
              <h5 class="text-dark mb-0"><img src="http://127.0.0.1:3000/img/product_detail/product_detail_icon_d_1.png" alt=""> 售后保障</h5>
            </a>
            <a class="btn p-3 pl-4 pr-4 mb-2" href="#包装清单">
              <h5 class="text-dark mb-0"><img src="http://127.0.0.1:3000/img/product_detail/product_detail_icon_bao_1.png" alt=""> 包装清单</h5>
            </a>
            <a class="btn p-3 pl-4 pr-4 mb-2" href="#header">
              <h5 class="text-dark mb-0"><img src="http://127.0.0.1:3000/img/product_detail/product_detail_icon_up_1.png" alt=""> 回到顶部</h5>
            </a>
          </div>
        </div>
      </div>
  ...
  export default {
    ...
    data(){
      return {
        ...
        // 专门控制ulImgs的样式
        ulImgsStyle:{
          // 因为ulImgs在整个效果中会有两个样式发生变化所以必须有两个属性来支持变化
          width:0,
          "margin-left":0
        },
        moved:0,  //记录ul已经左移的li次数
        // lid:
        product:{price:0},  //防止toFixed()出错
        specs:[],
        pics:[],
      }
    },
    ...
    methods:{
      move(e){
        ...
        this.lgDivStyle["background-position"]=`-${left*16/7}px -${top*16/7}px`
      },
      display(){
        this.show=true;
      },
      ...
      moveLeft(){
        if(this.btnRightDisabled==false){
          this.moved++;   //就左移一次
          // 重新计算margin-left值
          this.ulImgsStyle['margin-left']=this.moved*-62+"px";
        }
      },
      moveRight(){
        // 如果左边按钮没有禁用
      ...
      load(){
        ...
        // this->当前组件对象
          ...
          // 根据pics中的图片张数初始化ulImgs的宽度
          this.ulImgsStyle.width=this.pics.length*62+"px";
          // 获得pics中第一张图片的初始化mImg和lgDiv的图片
